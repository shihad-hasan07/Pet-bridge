...
// Todo ---> these code for theme change
        ...
        <div>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to='/'>
                        <div className='w-32'>
                            <img src={logo} className="w-full object-cover object-center dark:invert" alt="Flowbite Logo" />
                        </div>
                    </Link>
                    ...
                    <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        {/* <!-- Dropdown menu --> user--dashboard--logout */}
                        <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            ...
                            <ul className="py-3 pt-1" aria-labelledby="user-menu-button">
                                <li>
                                ...
                                <li>
                                    <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Log out</button>
                                </li>
                            </ul>
                        </div>
